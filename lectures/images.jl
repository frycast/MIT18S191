...
@bind repeat_count Slider(1:20, show_value=true)
...
# ╔═╡ 9709e500-ee94-11ea-0297-d3f01ebcdd14
md"## Experimenting -- Daniel Fryer"

# ╔═╡ 88caeec0-ee95-11ea-22dd-1f5a5a41d3cd
philip

# ╔═╡ 10ddf1a0-ee95-11ea-0b63-3bf6ef1386f1
function swapify(c)
	return RGB(c.r*c.b, c.g*c.b, c.b*c.b)
end

# ╔═╡ b2bc0b20-ee94-11ea-0e97-61df7e3d45f0
swapify.(philip)

# ╔═╡ f9a4d3b0-ee98-11ea-3b58-3331ca84ec7a


# ╔═╡ f678c110-ee98-11ea-0ca4-cf4d5b21ad4b
new_philip = copy(philip)

# ╔═╡ c963f680-ee99-11ea-0b05-97c1e6dbf39a
function npi(n)
  trunc(Int,rem(10.0^(n-1)*pi,1)*10)	
end
